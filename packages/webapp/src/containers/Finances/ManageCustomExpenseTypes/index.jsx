...
import { customExpenseTypeTileContentsSelector, selectedExpenseSelector } from '../selectors';
...
export default function ManageExpenseTypes({ history }) {
  ...
  const customTypes = useSelector(customExpenseTypeTileContentsSelector);
